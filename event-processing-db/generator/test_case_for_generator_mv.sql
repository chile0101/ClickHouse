...
insert into user_profile
    ...
    ['facebook','google','youtube'] as sources
    select
           ...
           ['first_name','last_name','gender','location_city', 'context_campaign_source'] as `str_properties.keys`,
...
select * from segments_final_mv;
insert into segments values (1, 's1', ['a1','a2','a3', 'a6'], now());
insert into segments values (1, 's2', ['a8', 'a9'], now());
create database mv;
